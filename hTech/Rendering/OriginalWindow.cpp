...
void OriginalWindow::GetWindowSize(Vector2& size) const
{
	if (!m_IsInitialised)
		return;
...
void OriginalWindow::GetWindowTitle(std::string& title) const
{
...
void OriginalWindow::GetWindowPosition(Vector2& position) const
{
	//todo : add console values here
	//they apparently dont exist in the console.
