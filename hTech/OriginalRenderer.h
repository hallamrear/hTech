...
public:
	...
	void Render_Line(const Vector2& worldSpacePointA, const Vector2& worldSpacePointB);
	void Render_WorldSpaceRectangle(const WorldRectangle& rectangle, const RENDER_LAYER& layer = RENDER_LAYER::DEFAULT, bool filled = true, bool drawCentered = false);
	void Render_ScreenSpaceRectangle(const ScreenRectangle& rectangle, const RENDER_LAYER& layer = RENDER_LAYER::DEFAULT, bool filled = true, bool drawCentered = false);
